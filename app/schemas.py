...
class ProductCreate(BaseModel):
    ...
    price: Decimal = Field(..., gt=0, description="Цена товара", decimal_places=2)
...
class ReviewCreate(BaseModel):
    comment: str | None = Field(None, description="Введите ваш отзыв")
    grade: int = Field(..., ge=1, le=5, description="Введите вашу оценку (от 1 до 5)")
